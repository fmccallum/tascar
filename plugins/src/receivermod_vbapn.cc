...
*/
void rec_vbapn_t::add_pointsource( const TASCAR::pos_t& prel,
                                  double width,
...
TASCAR::receivermod_base_t::data_t* rec_vbapn_t::create_state_data(double srate,uint32_t fragsize) const
{
